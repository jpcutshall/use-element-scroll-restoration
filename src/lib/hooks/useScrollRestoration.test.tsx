...
describe('useScrollRestoration', () => {
  ...
  it('should debounce scroll events and update localStorage if specified', () => {
    ...
    Object.defineProperty(scrollableDiv, 'scrollLeft', { value: 0, writable: true });
  ...
  it('should save to sessionStorage if specified', () => {
    ...
    Object.defineProperty(scrollableDiv, 'scrollTop', { value: 75, writable: true });
    Object.defineProperty(scrollableDiv, 'scrollLeft', { value: 15, writable: true });
  ...
  it('should update scroll state when setScroll is called manually', () => {
    ...
    expect(JSON.parse(localStorage.getItem(`scrollRestoration-${MOCK_KEY}`) || '{}')).toEqual(
      { scrollTop: 150, scrollLeft: 50 }
    );
  });
});
